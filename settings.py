...
if platform.system() == 'Windows':
    ...
    CHROMEDRIVER_FOLDER   = os.path.realpath(os.path.join(__file__,os.pardir,os.pardir,'webdriver'))
    DOWNLOAD_PATH = os.path.abspath('/mnt/g/Drives compartilhados/[BIG] Upload/02. CAR/SHAPES CAR '+ datetime.today().strftime('%Y-%m-%d'))
