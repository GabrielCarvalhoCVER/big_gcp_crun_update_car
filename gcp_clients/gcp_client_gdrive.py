...
class GDrive_Client():
    ...
    def get_files(self, dict_param:dict={}, **param):
    ...
    def get_allfiles_of_parents(self, parents:Union[str,list], **param):
        ...
        for parents_idx in range(1,1+parents_chunk_ns):
            ...
            parents_qs =  '(' + ' or '.join(["'" + parent_row + "' in parents" for parent_row in parents_qs_list]) + ')'
            ...
            drivelist = drivelist + self.get_files(**param_q)
        ...
        if len_folders_id >0:
            drivelist = drivelist + self.get_allfiles_of_parents(parents=folders_id, **param)
        
        return drivelist
        
    #################################################################################################        

    def get_df_of_allfiles_of_parents(self, parents:list, columns:list=['id','name','driveId','parents','trashed','mimeType','version','size','modifiedTime','createdTime','properties','description','trashed'], **param):

        param['fields'] = "nextPageToken, files(" + ','.join(columns) + ")"
                
        drivelist = self.get_allfiles_of_parents(parents=parents , **param)
    ...
    def list_subfolders(self, parentId:str, trashed:bool=False , files_fields:str='id,name,parents'):
    ...
    def get_file(self, fileId:str, **param):
    ...
    def list_permissions(self, fileId:str, **param):
    ...
    def share_file(self, fileId:str, role:str, emailAddress:str, sendNotificationEmail:bool=False, **param):
    ...
    def list_revisions(self, fileId:str, **param):
    ...
    def get_first_modifying_user(self, fileId:str):
    ...
    def get_allparents(self, parentId:str, **param):
    ...
    def check_parenthood(self, parentId:str, parents_checklist:dict, **param):
    ...
    def update_file(self, fileId:str, updated_data:dict, **param):
    ...
    def rename_file(self, fileId:str, old_name_check:str, new_name:str, force_print:bool=False):
    ...
    def change_parent_of_file(self, fileId:str, old_parentId_check:str, new_parentId:str, force_print:bool=False):
    ...
    def copy_file(self, fileId:str, old_parentId_check:str, new_parentId:str, updated_data:dict={}, force_print:bool=False , **param):
    ...
    def untrash_file(self, fileId:str):

        self.update_file(fileId, updated_data = {'trashed': False})

    #################################################################################################        

    def trash_file(self, fileId:str):

        self.update_file(fileId, updated_data = {'trashed': True})    

        #################################################################################################        

    #################################################################################################        

    def download_file(self, fileId:str, filename_download:Union[str,None]=None, path=''):
    ...
    def update_media(self, fileId:str , media_path:str, update_name:bool=False, **param):
    ...
    def copy_media(self, fileId:str, fileId_to_copy:str, update_name:bool=False , **param):
    ...
    def get_bytes_str_of_file(self, fileId:str):
    ...
    def get_str_of_file(self, fileId:str, encoding:str=None):
    ...
    def create_folder(self, folder_name:str, parentId:str, driveId:Union[str,None]=None):
    ...
    def createget_folder(self, driveId:str, folder_name:str, parentId:str):
    ...
    def get_changes(self, dict_param:dict={}, **param):
        '''
    ...
    def get_StartPageToken(self, driveId:Union[str,None]=None ):
        """
        driveId = None
