...
def do_trunc_or_create_table(df, table:str, schema:str, engrawconn_db=None , db_json:Union[dict,None]=None, db_env:Union[str,None]=None , db_secret:Union[dict,None]=None , truncate=False , updateIdValues=[] , updateColumnName='' , pk_cols=None , force_clean_columns:bool=False):
...
def create_table(df, schema:str, table:str, engrawconn_db=None, db_json:Union[dict,None]=None, db_env:Union[str,None]=None , db_secret:Union[dict,None]=None , pk_cols=None, force_clean_columns:bool=True):
...
def upsert_db(gdf, schema:str, table:str, engrawconn_db =None, db_json:Union[dict,None]=None, db_env:Union[str,None]=None , db_secret:Union[dict,None]=None , force_print:bool=False):
    ...
    cur_db = rawconn_db.cursor()
    gdf.columns = ['"' +col + '"'  for col in gdf.columns]
    gdf.index = gdf.index.rename('"'+gdf.index.name+'"')
    ...
    sql_str =         """
        ...
        set 
        \t""" + ',\n\t\t'.join(gdf.columns + ' = excluded.' + gdf.columns)  + """
        ;
        """
...
def update_db(gdf, schema, table, truncate=True , crud = False, crud_function = None, engrawconn_db =None, force_update=True , db_json:Union[dict,None]=None, db_env:Union[str,None]=None , db_secret:Union[dict,None]=None , updateIdValues=[] , updateColumnName='' , pk_cols=None , force_print=False , force_geometry3d=False):
...
def update_db_output(df_chunk, schema:str, table:str, engrawconn_db , force_print:bool=False , force_geometry3d:bool=False):
